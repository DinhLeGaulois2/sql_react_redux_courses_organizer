...
import DisplayACourse from '../../components/courses_organizer/DisplayACourseComponent'
...
class DisplayCoursesComponent extends React.Component {
    ...
    render() {
        const { data, getACourse, deleteACourse, isList } = this.props
