...
class Header extends Component {
  renderNavLinks() {
    if (this.props.authenticated) {
      return (
        <div>
          <NavLink to="/mainMenu" className="navLink" strict activeStyle={{ color: 'blue' }}>Courses</NavLink>
  ...
  render() {
    return (
      <div className="header" style={{ "backgroundColor": "black" }}>
        <span style={{ color: "black", backgroundColor: "white", fontSize: "1.5em", padding: '0px 10px', fontWeight: "bold" }}>Courses Organizer</span>
