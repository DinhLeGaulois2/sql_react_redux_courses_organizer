...
module.exports = function (app) {
    ...
    app.delete("/api/delete/course/:id", requireAuth, (req, res, next) => {
    ...
    app.delete("/api/delete/instructor/:id", requireAuth, (req, res, next) => {// We need to use TRANSACTION to delete 3 documents in 3 tables
        return sequelize.transaction(t => {
    ...
    app.delete("/api/delete/student/:id", requireAuth, (req, res, next) => {
        return sequelize.transaction(t => {
