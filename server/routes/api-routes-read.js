...
module.exports = function (app) {
    ...
    app.get("/api/get/course/:id", requireAuth, (req, res, next) => {
    ...
    app.get("/api/get/instructor/:id", requireAuth, (req, res, next) => {
        db.person.findAll({
            where: { id: req.params.id },
    ...
    app.get("/api/get/instructors", requireAuth, (req, res, next) => {
        db.person.findAll({
    ...
    app.get("/api/get/student/:id", requireAuth, (req, res, next) => {
        db.person.findOne({
            where: { id: req.params.id },
            attributes: ['id', 'lastName', 'firstName'],
            include: [{
